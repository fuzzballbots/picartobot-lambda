...
class Pusher {
  ...
  work(done) {
    ...
    // TODO: implement the work of pushing data to the DISCORD webhooks
  }
  ...
  startup() {
    this.work((data, err) => {
      ...
      if (err) { 
        ...
        this.sendFile(data.buffer.toString('base64'), data.vehicleImageMimeType);
      }
    });
  }
}

module.export = Pusher;
